...
OUT_CRATES_BOOTLOADER = $(OUT_CRATES_DIR)/libbootloader.rlib

.PHONY: crate-bootloader
crate-bootloader: $(OUT_CRATES_BOOTLOADER)

$(OUT_CRATES_BOOTLOADER): $(IN_CRATE_BOOTLOADER_SRCS) $(OUT_RUST_CORE_LIB) $(OUT_RUST_COMPILER_BUILTINS_LIB) | $(OUT_CRATES_DIR)
	rustc $(RUSTC_FLAGS) \
		--crate-type rlib \
		--crate-name bootloader \
		-o $@ \
		$(IN_CRATE_BOOTLOADER_SRC_DIR)/lib.rs
